...
def numbers(n: int, mini: int, maxi: int, n_flag: bool =False, dis: bool =False) -> None:
    if n_flag:
        print(n)
...
def array(n: int, size: int, mini: int, maxi: int, n_flag: bool =False, size_flag: bool =False, dis: bool =False) -> None:
    if n_flag:
        print(n)
...
def matrix(n: int, r: int, c: int, mini: int, maxi: int, n_flag: bool =False, nm_flag: bool =False, dis: bool =False) -> None:
    if n_flag:
        print(n)
...
def string(n: int, size: int, charset: str, n_flag: bool =False, size_flag: bool =False, dis: bool =False) -> None:
    if n_flag:
        print(n)
...
def string_matrix(n: int, r: int, c: int, charset: str, n_flag: bool =False, nm_flag: bool =False, dis: bool =False) -> None:
    if n_flag:
        print(n)
...
if __name__ == '__main__':
    ...
    if opt == 1:
        ...
        numbers(n, mini, maxi, n_flag, dis)
    elif opt == 2:
        print("! Type of Array !")
        ...
        if choice == 1:
            ...
            array(n, size, mini, maxi, n_flag, size_flag, dis)
        elif choice == 2:
            n, r, c, mini, maxi, n_flag, nm_flag, dis = input_data3()
            matrix(n, r, c, mini, maxi, n_flag, nm_flag, dis)
    elif opt == 3:
        ...
        if choice == 1:
            ...
            string(n, size, charset, n_flag, size_flag, dis)
        elif choice == 2:
            n, r, c, charset, n_flag, nm_flag, dis = input_data5()
            string_matrix(n, r, c, charset, n_flag, nm_flag, dis)
    else:
